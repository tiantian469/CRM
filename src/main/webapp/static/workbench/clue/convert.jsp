...
<script type="text/javascript">
	$(function(){
		...
		$("#searchActivityInConvert").click(function () {
			pageList(1,5);
		...
		$("#onchange").click(function () {
			if($("#isCreateTransaction").prop("checked")){
				...
				alert("走了不提交表单的路线！");
				window.location.href = "clue/changeClue.do?clueId=${param.id}";
			}
		})
	});
	function pageList(pageNo,pageSize) {
		...
		$.ajax({
			url:"clue/queryActivityWithName.do",
			data:{
			...
			success:function (response) {
				...
				$.each(response.pageList,function (index,element) {
					html += '<tr>'
					html += '<td><input type="radio" name="check" value="'+element.id+'"/></td>'
...
<body>
					...
					<div class="btn-group" style="position: relative; top: 18%; left: 8px;">
						<form class="form-inline" role="form">
						  <div class="form-group has-feedback">
						    <input type="text" class="form-control" id="inputText" style="width: 300px;" placeholder="请输入市场活动名称，支持模糊查询">
	...
	<div id="create-transaction2" style="position: relative; left: 40px; top: 20px; width: 80%; background-color: #F7F7F7; display: none;" >
		...
		<form id="tran" action="clue/changeClue.do" method="post">
		  ...
		  <div class="form-group" style="width: 400px;position: relative; left: 20px;">
		    <label for="activity">市场活动源&nbsp;&nbsp;<a href="javascript:void(0);" id="searchActivityInConvert" style="text-decoration: none;"><span class="glyphicon glyphicon-search"></span></a></label>
	...
	<div id="operation" style="position: relative; left: 40px; height: 35px; top: 100px;">
		<input class="btn btn-primary" type="button" id="onchange" value="转换">
		&nbsp;&nbsp;&nbsp;&nbsp;
